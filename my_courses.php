...
if (isset($_POST['drop_course'])) {
    ...
    if ($stmt->execute()) {
        $message = '<div class="alert alert-success">Course dropped successfully!</div>';
    } else {
        $message = '<div class="alert alert-danger">Failed to drop course!</div>';
    }
}

$query = "SELECT c.id, c.course_code, c.course_name, c.credits, r.registered_at 
          FROM courses c 
        ...
        <div class="row">
            <div class="col-md-8">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo date('M d, Y', strtotime($course['registered_at'])); ?></td>
                                <td>
                ...
                <div class="alert alert-info">
                    You haven't registered for any courses yet. <a href="courses.php">Browse available courses</a>
                </div>
                <?php endif; ?>
            </div>
            ...
            <div class="col-md-4">
                <div class="card bg-primary text-white">
                    <div class="card-body">
                        ...
                        <h2 class="display-4"><?php echo $total_credits; ?></h2>
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <a href="courses.php" class="btn btn-primary w-100 mb-2">Register More Courses</a>
